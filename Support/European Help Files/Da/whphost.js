	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Det flettede hjælpesystem "+aRProj[0].sPPath+" anvender et andet sprog end hovedhjælpesystemet, hvilket medfører, at indekset og fuldtekst-søgefunktionaliteten deaktiveres i det flettede hjælpesystem.");
		}
		...
		alert("Kunne ikke indlæse korrekt, klik på Genopfrisk.");
}
